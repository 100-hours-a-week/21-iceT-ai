...
from src.chatbot.core.v1.prompt_templates import SOLUTION_PROMPT
from src.chatbot.adapters.v1.llm_client import generate_solution
from src.chatbot.schemas.v1.solution_schema import SolutionRequest, SolutionResponse
